...
- **[dev/](./dev)**: The software engineering environment, including editors, devshell-provided language stacks, envoluntary mappings, multiplexers, and version control.
